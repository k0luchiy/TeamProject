...
namespace TeamProject {
	...
	/// <summary>
	/// Summary for TextEditorForm
	/// </summary>
	public ref class TextEditorForm : public System::Windows::Forms::Form
	{
	public:
		TextEditorForm(void)
		{
		...
		TextEditorForm(System::Windows::Forms::Form^ parent_form)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toMenuToolStrip->Click += gcnew System::EventHandler(this, &TextEditorForm::toMenuToolStrip_Click);
			// 
			// aboutToolStrip
			// 
			...
			this->aboutToolStrip->Click += gcnew System::EventHandler(this, &TextEditorForm::aboutToolStrip_Click);
			// 
			// exitToolStrip
			// 
			...
			this->exitToolStrip->Click += gcnew System::EventHandler(this, &TextEditorForm::exitToolStrip_Click);
			...
			this->Name = L"TextEditorForm";
			this->Text = L"TextEditorForm";
